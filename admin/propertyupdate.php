...
if(isset($_POST['submit'])){
   ...
   $sql = "UPDATE property SET utitle='{$title}', ulocation='{$loc}', uprice='{$price}', uroom ='{$room}',ukitchen ='{$kitchen}',ubathroom ='{$bath}',uwater ='{$water}',usecuritty ='{$sec}',upeople ='{$people}',ulightfee ='{$lightfee}', usecurityfee ='{$securityfee}',uduration ='{$dur}', p_id ='{$user_id}',uid ='{$uid}', ubuildpic ='{$aimg}', uroompic ='{$aimg1}',ukitchenpic ='{$aimg2}', ubathroompic ='{$aimg3}', uuserpic ='{$aimg4}' WHERE pid ='$pid'";
