    ...
    <div class="users-table">
        <table class="table table-striped table-responsive">
            ...
            <tbody>
                <?php
                $id = $_GET['id'];   
                $sqlOne = "SELECT * FROM hostelproposal WHERE prop_id = $id";
                ...
                $sql = "SELECT * FROM property WHERE uprice = $price LIMIT ".$startinglimit.','.$numberPages;
                ...
                ?>
                    <tr>
                        ...
                        <td data-cell="Duration"><?php
                                                    echo $row[15];
                                                    ?></td>
                        <td data-cell="Action" class="prop-btn"><a href="addstudent.php?id=<?php
                                                                                echo $row[0];
                                                                                ?>"><button class="action">Allocate</button></a></td>
                    </tr>
                <?php
                }
                ?>
